...
<pre class="command">pear uninstall channel://__uri/templum-0.2.0</pre>
<p>You can directly install Templum from the Internet if you've got PEAR installed with the following command:</p>
<pre class="command">pear install http://templum.electricmonk.nl/releases/templum-0.3.0.tgz</pre>
<p>You can also download the PEAR package manually and install it with:</p>
<pre class="command">pear install ./templum-0.3.0.tgz</pre>
<p><a href="http://templum.electricmonk.nl/releases/templum-0.3.0.tgz">http://templum.electricmonk.nl/releases/templum-0.3.0.tgz</a></p>
